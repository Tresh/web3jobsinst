...
const navItems = [
  ...
  { label: "Internship", href: "/dashboard/internship", icon: Briefcase, badge: "Beta" },
  { label: "Messages", href: "/dashboard/messages", icon: MessageSquare },
  { label: "Bootcamps", href: "/dashboard/bootcamps", icon: Flame, badge: "Beta" },
  { label: "Campaigns", href: "/dashboard/campaigns", icon: Megaphone },
  { label: "LearnFi", href: "/dashboard/learnfi", icon: Zap, badge: "Beta" },
  ...
  { label: "Talent Profile", href: "/dashboard/talent", icon: Users, badge: "Beta" },

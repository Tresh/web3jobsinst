...
const CoursesNavbar = ({
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-background border-b border-secondary pwa-safe-header" style={{ height: 'calc(72px + env(safe-area-inset-top, 0px))' }}>
